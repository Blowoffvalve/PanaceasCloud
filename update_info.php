                    ...
                    <div class="col-lg-12">
                        <?php
                            ...
                            if (!isset($_POST["edit"])&& !isset($_POST["update"])){
                                ...
                                $sql = "SELECT S_ID, First_Name, Last_Name, Status FROM tempstaffs WHERE S_ID = ".$_POST["edit"];
                                $result = $db->query($sql);
                                if ($result->num_rows){
                                    echo "<table class=\"table table-bordered\"><th colspan = \"2\">Update</th><tbody>";
                                    echo "<form method = 'POST' action = '".htmlspecialchars($_SERVER["PHP_SELF"])."'>";
                                    $row = $result->fetch_assoc();
                                        echo "<tr><td>ID</td><td>".$row["S_ID"]."</td></tr>";
                                ...
                                $sql = "UPDATE tempstaffs SET Status = '".$_POST['search_by']."' WHERE S_ID = ".$_POST['id'];
                                $result = $db->query($sql);
                                //echo $result;
                                if ($result === TRUE){
