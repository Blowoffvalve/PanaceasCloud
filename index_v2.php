            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div id='legend' style='display:none;'>
                          <strong>Legend of Markers</strong>
                          <nav class='legend clearfix'>
                            <span style='background:#ff3c3c;'></span>
                            <span style='background:#3cff9e;'></span>
                            <span style='background:#ffff3c;'></span>
                            <span style='background:#414141;'></span>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group" >
                            ...
                            <div class="form-group input-group">
                                <input type="text" class="form-control" id = "locationSearchBar" ng-model = "locationSearchBar" placeholder ="Search by location">
