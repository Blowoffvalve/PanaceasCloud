...
<body>
  ...
  <div class="modal-body">
        ...
        <div class = "row">
          <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>">
            <button type="submit" class="btn btn-primary" name="defaultOrderSubmit">
        ...
        <div class = "row">
          <div class="con">         
            <table class="table table-bordered sortable">
              <thead>
                <tr>
                  <th class="sorttable_nosort">Add Patient</th>
                      ...
                      case "I_ID":
                          ...
                          if(count($result) != 0 ){
                            foreach ($result as $row) {
                                ...
                                $viewIncident .= "<tr><td><button id = 'addPBtn' type='submit' value = '".$row['I_ID']."'class='btn btn-info btn-sm btn-block' name='addPatient'><span class='glyphicon glyphicon-plus'></span></button></td></form>";
                                $viewIncident .= "<td><button id = 'subBtn' type='submit' value = '".$row['I_ID']."' class='btn btn-primary btn-sm btn-block' name='edit' data-toggle='modal' data-target='#edit_".$row['I_ID']."'><span class='glyphicon glyphicon-pencil'></span></button></td>";
                                $viewIncident .= "<td><button id = 'rmBtn' type='submit' value = '".$row['I_ID']."'class='btn btn-danger btn-sm btn-block' name='remove' data-toggle='modal' data-target='#remove_".$row['I_ID']."'><span class='glyphicon glyphicon-trash'></span></button></td>";
